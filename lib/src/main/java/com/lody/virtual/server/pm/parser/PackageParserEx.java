...
public class PackageParserEx {
    ...
    private static VPackage buildPackageCache(PackageParser.Package p) {
        ...
        addOwner(cache);
        injectXposedModuleInfo(cache);//这里说白了就是在给 安装的应用程序装 xposed 模块
        return cache;
    }
    ...
    public static void initApplicationInfoBase(PackageSetting ps, VPackage p) {
        ...
        if (sharedLibraryFiles == null) {
            ...
            if (Build.VERSION.SDK_INT >= 28 /*&& ai.targetSdkVersion <= 29*/) {
                String APACHE_LEGACY_JAR = FileUtils.isExist("/system/framework/org.apache.http.legacy.boot.jar")
...
//                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                    //support split apk
//                    if (!ArrayUtils.isEmpty(outside.splitSourceDirs)) {
//                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//                            String[] splitNames = outside.splitNames;
//                            if (splitNames != null) {
//                                ai.splitNames = splitNames.clone();
//                            }
//                        }
//                        String[] splitSourceDirs = outside.splitSourceDirs;
//                        String[] splitPublicSourceDirs = outside.splitPublicSourceDirs;
//                        if (splitSourceDirs != null) {
//                            ai.splitSourceDirs = splitSourceDirs.clone();
//                        }
//                        if (splitPublicSourceDirs != null) {
//                            ai.splitPublicSourceDirs = splitPublicSourceDirs.clone();
//                        }
...
//                            if (ApplicationInfoO.splitDependencies != null) {
//                                splitDependencies = ApplicationInfoO.splitDependencies.get(outside);
//                            }
//                            if (ApplicationInfoP.splitClassLoaderNames != null) {
//                                splitClassLoaderNames = ApplicationInfoP.splitClassLoaderNames.get(outside);
//                            }
//                            if (splitDependencies != null) {
//                                ApplicationInfoO.splitDependencies.set(ai, splitDependencies);
//                            }
//                            if (splitClassLoaderNames != null) {
//                                ApplicationInfoP.splitClassLoaderNames.set(ai, splitClassLoaderNames);
//                            }
//                        }
//                    } else {
