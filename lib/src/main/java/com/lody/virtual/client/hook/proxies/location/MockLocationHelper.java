...
public class MockLocationHelper {
    ...
    public static void fakeGpsStatusN(android.location.LocationManager locationManager) {
        ...
        Object object = LocationManager.mGpsStatusListeners.get(locationManager);
        if (object instanceof HashMap) {
            HashMap mGpsStatusListeners = (HashMap) object;
            ...
            ArrayMap mGpsStatusListeners = (ArrayMap) object;
            for (Object listenerTransport : mGpsStatusListeners.values()) {
                invokeSvStatusChanged(listenerTransport);
                break;
            }
