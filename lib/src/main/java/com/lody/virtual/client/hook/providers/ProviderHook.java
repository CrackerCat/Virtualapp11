    ...
    public Object invoke(Object proxy, Method method, Object... args) throws Throwable {
        ...
        try {
            ...
            if ("call".equals(name)) {
                ...
                }else {//这里是在小米 11 上面 出现 java.lang.ClassCastException: java.lang.String cannot be cast to android.os.Bundle
                    String extras = (String) args[start + 2];
                    return call(methodBox, methodName, arg, null);
                }
