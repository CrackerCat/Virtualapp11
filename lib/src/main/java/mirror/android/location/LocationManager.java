...
public class LocationManager {
    ...
    public static class ListenerTransport {
        public static Class<?> TYPE = RefClass.load(ListenerTransport.class, (Build.VERSION.SDK_INT >= 30?"android.location.LocationManager$LocationListenerTransport":"android.location.LocationManager$ListenerTransport"));
